...
requires:
  - phase: 01-reactive-core
    provides: signal, computed, effect, createRoot primitives in /core dist
provides:
  - apps/bench package with tinybench benchmark suites for signal, computed, and effect
  - Reproducible ops/sec comparison between /core, @preact/signals-core, and solid-js
...
key-decisions:
  ...
  - "Used createRoot() wrapper in /core benchmarks to suppress DX-02/DX-03 owner warnings — production-like isolation per iteration"
...
**tinybench benchmark suite comparing /core signal/computed/effect ops/sec against @preact/signals-core and solid-js across 9 benchmark cases**
...
## Accomplishments
- Created apps/bench ESM package with tinybench, @preact/signals-core, solid-js, and /core workspace dep
...
- `apps/bench/package.json` - ESM package with tinybench, @preact/signals-core, solid-js, /core workspace dependencies
...
- createRoot() wrapper used per benchmark iteration to suppress DX-02/DX-03 owner warnings in /core, providing production-like isolation
...
- /core is measurably slower than competitors — correctness-first design; optimization is future work
